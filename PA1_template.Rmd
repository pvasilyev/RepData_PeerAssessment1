...
par(mfrow = c(2, 1))
plot(
    strptime(mean_steps_by_weekday$interval, "%H%M"), 
    mean_steps_by_weekday$steps, 
    type = "l", 
    xlab = "Time Interval", 
    main = "Week Day", 
    ylab = "Total steps made", 
    col = "blue"
)
plot(
    strptime(mean_steps_by_weekend$interval, "%H%M"), 
    mean_steps_by_weekend$steps, 
    type = "l", 
    xlab = "Time Interval", 
    main = "Week End", 
    ylab = "Total steps made", 
